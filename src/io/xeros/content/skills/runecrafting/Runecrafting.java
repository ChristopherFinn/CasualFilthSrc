...
public class Runecrafting extends SkillHandler {
	...
	public enum RunecraftingData {
		...
		DEATH(25035, 560, 15, new int[] { 65, 84, 9697, 98, 99 }, 19000, 20685),
		BLOOD(43848, 565, 17, new int[] { 77, 89, 94, 95, 96, 97, 98, 99 }, 18800, 20691),
		WRATH(25380, 21880, 15, new int[] { 95, 96, 97, 98, 99 }, 18800, 20691),
